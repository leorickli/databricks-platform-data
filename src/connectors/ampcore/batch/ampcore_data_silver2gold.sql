...
CREATE OR REFRESH STREAMING TABLE gold.f_ampcore_econnection_measurements (
  ...
  timestamp              TIMESTAMP NOT NULL COMMENT 'UTC timestamp of the 30-second reading (cast from epoch seconds returned by the AMPCORE SCU200 API)',
  ...
  CONSTRAINT pk_f_ampcore_econnection_measurements PRIMARY KEY (sk_econnection, timestamp)
)
CLUSTER BY AUTO
COMMENT
