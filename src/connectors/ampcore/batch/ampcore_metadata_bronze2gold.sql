...
CREATE OR REFRESH MATERIALIZED VIEW gold.d_abb_econnections (
  ...
  asset_type                STRING    COMMENT 'ESDL EConnection.asset_type — always ''ABB SCU200 CurrentSensor''',
  manufacturer              STRING    COMMENT 'ESDL EConnection.manufacturer — always ''ABB''',
  ...
  gateway_id                STRING    COMMENT 'ABB SCU200 gateway identifier (natural key component)',
  gateway_ip                STRING    COMMENT 'ABB SCU200 gateway IP address at snapshot time',
  gateway_serial_number     STRING    COMMENT 'ABB SCU200 gateway serial number',
